...
; 0000 0028 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=In
; 0000 0029 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (1<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(2)
	OUT  0x1A,R30
; 0000 002A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=T
...
; 0000 006B TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (1<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(16)
	OUT  0x39,R30
; 0000 006C 
...
; 0000 0090 while (1){
_0x3:
; 0000 0091     if (PINA & 0x01 == 0x01) {
	SBIS 0x19,0
	RJMP _0x6
; 0000 0092         OCR1AH=0x7A;
	LDI  R30,LOW(122)
	OUT  0x2B,R30
; 0000 0093         OCR1AL=0x12;
	LDI  R30,LOW(18)
	RJMP _0x9
; 0000 0094     }
; 0000 0095     else {
_0x6:
; 0000 0096         OCR1AH=0x3D;
	LDI  R30,LOW(61)
	OUT  0x2B,R30
; 0000 0097         OCR1AL=0x09;
	LDI  R30,LOW(9)
_0x9:
	OUT  0x2A,R30
; 0000 0098     }
