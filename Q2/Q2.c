...
unsigned char read_adc(unsigned char channel)
{
    ...
    ADMUX = 0x40 | (1 << ADLAR) | (channel & 0x07);
...
// Output Pulse(s):
// OC0 Period: 2.048 ms Width: 1.028 ms
...
while (1)
      {
          ...
          int engine = read_adc(1);
          int degree = read_adc(0);
